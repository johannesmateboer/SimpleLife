...
import simplelife.common.inventory.BasicInventory;


public class CabinetEntity extends BlockEntity implements NamedScreenHandlerFactory, BasicInventory {

    private final DefaultedList<ItemStack> items = DefaultedList.ofSize(9, ItemStack.EMPTY);

    public CabinetEntity() {
        super(SimpleLife.CABINET_ENTITY);
    }
